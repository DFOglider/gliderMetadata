"""Auto-generated wrapper for scripts/add/addNewArgosTagPTTandSN.py.

Do not edit by hand. Regenerate with:  python scripts/tools/makeCommands.py
The logic lives in scripts/add/addNewArgosTagPTTandSN.py
"""
...
SCRIPT = PROJECT_ROOT / "scripts/add/addNewArgosTagPTTandSN.py"


class Command(BaseCommand):
    help = "Run scripts/add/addNewArgosTagPTTandSN.py"
