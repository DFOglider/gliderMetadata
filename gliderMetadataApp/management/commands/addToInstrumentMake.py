"""Auto-generated wrapper for scripts/add/addToInstrumentMake.py.

Do not edit by hand. Regenerate with:  python scripts/tools/makeCommands.py
The logic lives in scripts/add/addToInstrumentMake.py
"""
...
SCRIPT = PROJECT_ROOT / "scripts/add/addToInstrumentMake.py"


class Command(BaseCommand):
    help = "Run scripts/add/addToInstrumentMake.py"
