"""Auto-generated wrapper for scripts/add/addNewInstrument.py.

Do not edit by hand. Regenerate with:  python scripts/tools/makeCommands.py
The logic lives in scripts/add/addNewInstrument.py
"""
...
SCRIPT = PROJECT_ROOT / "scripts/add/addNewInstrument.py"


class Command(BaseCommand):
    help = "Run scripts/add/addNewInstrument.py"
