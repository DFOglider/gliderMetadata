"""Auto-generated wrapper for scripts/add/addPlatformPayload.py.

Do not edit by hand. Regenerate with:  python scripts/tools/makeCommands.py
The logic lives in scripts/add/addPlatformPayload.py
"""
...
SCRIPT = PROJECT_ROOT / "scripts/add/addPlatformPayload.py"


class Command(BaseCommand):
    help = "Run scripts/add/addPlatformPayload.py"
