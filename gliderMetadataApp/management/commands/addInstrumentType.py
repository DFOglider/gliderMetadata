"""Auto-generated wrapper for scripts/add/addInstrumentType.py.

Do not edit by hand. Regenerate with:  python scripts/tools/makeCommands.py
The logic lives in scripts/add/addInstrumentType.py
"""
...
SCRIPT = PROJECT_ROOT / "scripts/add/addInstrumentType.py"


class Command(BaseCommand):
    help = "Run scripts/add/addInstrumentType.py"
