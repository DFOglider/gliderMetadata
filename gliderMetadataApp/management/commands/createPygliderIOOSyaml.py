"""Auto-generated wrapper for scripts/createPygliderIOOSyaml.py.

Do not edit by hand. Regenerate with:  python scripts/tools/makeCommands.py
The logic lives in scripts/createPygliderIOOSyaml.py
"""
...
SCRIPT = PROJECT_ROOT / "scripts/createPygliderIOOSyaml.py"


class Command(BaseCommand):
    help = "Run scripts/createPygliderIOOSyaml.py"
