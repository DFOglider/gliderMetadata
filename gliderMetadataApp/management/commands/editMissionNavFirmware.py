"""Auto-generated wrapper for scripts/edit/editMissionNavFirmware.py.

Do not edit by hand. Regenerate with:  python scripts/tools/makeCommands.py
The logic lives in scripts/edit/editMissionNavFirmware.py
"""
...
SCRIPT = PROJECT_ROOT / "scripts/edit/editMissionNavFirmware.py"


class Command(BaseCommand):
    help = "Run scripts/edit/editMissionNavFirmware.py"
