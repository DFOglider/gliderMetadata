"""Auto-generated wrapper for scripts/add/addToInstrumentModel.py.

Do not edit by hand. Regenerate with:  python scripts/tools/makeCommands.py
The logic lives in scripts/add/addToInstrumentModel.py
"""
...
SCRIPT = PROJECT_ROOT / "scripts/add/addToInstrumentModel.py"


class Command(BaseCommand):
    help = "Run scripts/add/addToInstrumentModel.py"
