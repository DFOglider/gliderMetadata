"""Auto-generated wrapper for scripts/add/addToInstrumentType.py.

Do not edit by hand. Regenerate with:  python scripts/tools/makeCommands.py
The logic lives in scripts/add/addToInstrumentType.py
"""
...
SCRIPT = PROJECT_ROOT / "scripts/add/addToInstrumentType.py"


class Command(BaseCommand):
    help = "Run scripts/add/addToInstrumentType.py"
