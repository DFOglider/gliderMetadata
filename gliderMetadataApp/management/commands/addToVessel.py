"""Auto-generated wrapper for scripts/add/addToVessel.py.

Do not edit by hand. Regenerate with:  python scripts/tools/makeCommands.py
The logic lives in scripts/add/addToVessel.py
"""
...
SCRIPT = PROJECT_ROOT / "scripts/add/addToVessel.py"


class Command(BaseCommand):
    help = "Run scripts/add/addToVessel.py"
