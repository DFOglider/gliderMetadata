"""Auto-generated wrapper for scripts/add/addToContributorPeople.py.

Do not edit by hand. Regenerate with:  python scripts/tools/makeCommands.py
The logic lives in scripts/add/addToContributorPeople.py
"""
...
SCRIPT = PROJECT_ROOT / "scripts/add/addToContributorPeople.py"


class Command(BaseCommand):
    help = "Run scripts/add/addToContributorPeople.py"
