"""Auto-generated wrapper for scripts/edit/editComment.py.

Do not edit by hand. Regenerate with:  python scripts/tools/makeCommands.py
The logic lives in scripts/edit/editComment.py
"""
...
SCRIPT = PROJECT_ROOT / "scripts/edit/editComment.py"


class Command(BaseCommand):
    help = "Run scripts/edit/editComment.py"
