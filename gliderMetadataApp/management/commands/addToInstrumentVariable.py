"""Auto-generated wrapper for scripts/add/addToInstrumentVariable.py.

Do not edit by hand. Regenerate with:  python scripts/tools/makeCommands.py
The logic lives in scripts/add/addToInstrumentVariable.py
"""
...
SCRIPT = PROJECT_ROOT / "scripts/add/addToInstrumentVariable.py"


class Command(BaseCommand):
    help = "Run scripts/add/addToInstrumentVariable.py"
