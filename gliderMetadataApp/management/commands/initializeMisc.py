"""Auto-generated wrapper for scripts/initialize/initializeMisc.py.

Do not edit by hand. Regenerate with:  python scripts/tools/makeCommands.py
The logic lives in scripts/initialize/initializeMisc.py
"""
...
SCRIPT = PROJECT_ROOT / "scripts/initialize/initializeMisc.py"


class Command(BaseCommand):
    help = "Run scripts/initialize/initializeMisc.py"
