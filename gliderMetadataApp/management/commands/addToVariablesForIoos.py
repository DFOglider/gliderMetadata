"""Auto-generated wrapper for scripts/add/addToVariablesForIoos.py.

Do not edit by hand. Regenerate with:  python scripts/tools/makeCommands.py
The logic lives in scripts/add/addToVariablesForIoos.py
"""
...
SCRIPT = PROJECT_ROOT / "scripts/add/addToVariablesForIoos.py"


class Command(BaseCommand):
    help = "Run scripts/add/addToVariablesForIoos.py"
