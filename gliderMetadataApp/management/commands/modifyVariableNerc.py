"""Auto-generated wrapper for scripts/modifyVariableNerc.py.

Do not edit by hand. Regenerate with:  python scripts/tools/makeCommands.py
The logic lives in scripts/modifyVariableNerc.py
"""
...
SCRIPT = PROJECT_ROOT / "scripts/modifyVariableNerc.py"


class Command(BaseCommand):
    help = "Run scripts/modifyVariableNerc.py"
